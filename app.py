...
LOCATIONS = [
    ...
    },
    {
        ...
        "category": "რესტორანი",
        "category_en": "Restaurant",
        "description_ka": "პოპულარული ჩეხური რესტორანი ძველ ქალაქში. ცნობილია ტანკიდან პირდაპირ ჩამოცხელებული Pilsner Urquell ლუდითა და ავთენტური კერძებით.",
        "description_en": "Famous Czech restaurant in Old Town. Known for fresh tank-served Pilsner Urquell beer and authentic dishes.",
