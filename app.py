...
LOCATIONS = [
    ...
    },
    {
        ...
        "category": "სანახაობა",
        "category_en": "Sightseeing",
        "description_ka": "მსოფლიოში ერთ-ერთი საუკეთესო ზოოპარკი. პრაღა 1-დან მისასვლელად ჩადიხართ მეტრო C-თი (წითელი ხაზი) სადგურ Nádraží Holešovice-მდე, საიდანაც გადაჯდებით #112 ავტობუსში (მთლიანი დრო: 20-25 წთ). ტრანსპორტის ბილეთი: 30 CZK (30 წუთი) ან 40 CZK (90 წუთი).",
        "description_en": "One of the world's best zoos. To get there from Prague 1: take Metro line C (red) to Nádraží Holešovice, then switch to Bus #112 (total time: 20-25 min). Transport ticket: 30 CZK (30 min) or 40 CZK (90 min).",
    ...
    # =========================================================
    # --- ტოპ 10 ლუდის რესტორანი და ლუდსახარში ---
    # =========================================================
    {
        "title": "U Fleků",
        "category": "რესტორანი",
        "category_en": "Restaurant",
        "description_ka": "პრაღის ყველაზე ძველი მოქმედი ლუდსახარში და რესტორანი, რომელიც 1499 წლიდან ფუნქციონირებს. ცნობილია თავისი უნიკალური მუქი ლუდით (Dark Lager) და ტრადიციული ჩეხური კერძებით.",
        "description_en": "Prague's oldest operating brewery and restaurant, functioning since 1499. Famous for its unique dark lager and traditional Czech dishes.",
    ...
    },
    {
        ...
        "category": "რესტორანი",
        "category_en": "Restaurant",
        "description_ka": "პრაღის ერთ-ერთი უძველესი ლუდსახარში ძველი ქალაქის ცენტრში. გამოირჩევა გამჭვირვალე სახარში ავზებითა და საფირმო ნახევრად მუქი ლუდით.",
        "description_en": "One of Prague's oldest breweries in Old Town. Features visible glass brew kettles and signature semi-dark beer.",
